...
@section('content')
<table class="min-w-full divide-y divide-gray-200 my-20">
    <thead>
        <tr>
    ...
    <tbody class="bg-white divide-y divide-gray-200">
        ...
        <tr>
            ...
            <td class="px-6 py-4 whitespace-nowrap">
                @foreach ($participant->school as $school_name)
                    <span>{{ $school_name }}</span>,
                @endforeach
            </td>
            <td class="px-6 py-4 whitespace-nowrap">
                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">{{ $participant->campus }}</span>
            </td>
            <td class="px-6 py-4 whitespace-nowrap">
                <a href="{{ route('participant.show', $participant->id) }}" class="text-blue-300 underline">View More</a>
